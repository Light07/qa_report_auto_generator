...
if __name__ == '__main__':
    ...
    sprint_id = jira.get_sprint_id_by_sprint_name(settings.board_id, settings.sprint_name)
    ...
    #
    h.generate_report(settings.sprint_name, sprint_status, actual_points, sprint_bug_nested_list,\
